"""Deterministic checks for persistent quota and session limits."""

import asyncio
import os
import tempfile

from app.runtime_guard_v2 import GuardConfig, SessionLimiter, UsageStore, device_key
...
async def main() -> None:
    ...
    print("runtime-guard-ok persistence=true privacy_hash=true limits=true handles=closed")
